...
from ...audio_align_processor import align_audio_with_subtitles
...
class AlignAudioProcessor(StepProcessor):
    ...
    def _execute_process(self, task: Task) -> ProcessResult:
        ...
        try:
            ...
            aligned_audio_path = aligned_audio_dir / "aligned_tts_generation_results.wav"
            ...
            # 保存对齐结果到JSON文件
            aligned_results_path = aligned_audio_dir / "aligned_tts_generation_results.json"
